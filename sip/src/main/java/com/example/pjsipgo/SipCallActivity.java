...
public class SipCallActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private void initData() {
        ...
        mTvOutCallInfo.setText(String.format("You are calling %s", mNumber));
    ...
    @Override
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        SipServiceCommand.startVideoPreview(SipCallActivity.this, mAccountID, mCallID, mSvLocal.getHolder().getSurface());
    ...
    public BroadcastEventReceiver mReceiver = new BroadcastEventReceiver() {
        ...
        public void onIncomingCall(String accountID, int callID, String displayName, String remoteUri, boolean isVideo) {
            ...
            Toast.makeText(receiverContext, String.format("Incoming Call From [%s]", remoteUri), Toast.LENGTH_SHORT).show();
        }
